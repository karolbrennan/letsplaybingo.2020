        ...
        <div className="container row">
          <div
            ...
            <h1 className="no-margin">
              Instructions for{" "}
              <span className="notranslate">Let's Play Bingo</span>
            </h1>
            ...
            <ol>
              <li>
                <a href="#what-is-lpb">
                  What is{" "}
                  <span className="notranslate margin-left-sm">
                    Let's Play Bingo
                  </span>
                  ?
                </a>
            ...
            <p>
              <span className="notranslate padding-right-xsm">
                Let's Play Bingo
              </span>{" "}
              is a tool intended to be used for playing Bingo in a group setting
              - this can be either in person or online through virtual meetings
              with screen sharing.
            </p>
            ...
            <p>
              <span className="notranslate">Let's Play Bingo</span> utilizes an
              experimental technology called the Web Speech Synthesis API. This
              is primarily used for screen readers to read text back to vision
              impaired people. Support for this feature depends on your device
              and browser combination. If speech synthesis is not supported you
              will receive a message indiciating that the "Bingo Caller" option
              is not available for you. Please try another browser or different
              device if you'd like to use this feature.
            </p>
            <p className="small-text">
              <strong>Note:</strong> If you have having trouble with the audible
              caller on an iOS/Apple device, ensure that you have Siri enabled
              on your device. The Web Speech Synthesis API requires Siri to be
              enabled to work. Also, the latest Safari is known to have some
              issues with the API, including not loading any voice options, so
            ...
            <p>
              ...
              the caller will say "
              <span className="notranslate">Let's Play Bingo</span>!" or if
              using the Wild Bingo game mode, "Let's Play Wild Bingo!".
            </p>
            ...
            <p className="margin-top-none">
              ...
              and see if the issues persist. If they do, please send a detailed
              bug report to{" "}
            ...
            <p>
              If you come across issues with the game, please submit a detailed
              bug report via email to{" "}
              <a href="mailto:hello@letsplaybingo.io">hello@letsplaybingo.io</a>
              .
            </p>
            <p>
              Please follow the steps below when creating your report. With this
              information I will be able to address the issue much more quickly.
            </p>
            <ul>
              <li>What issue you're experiencing and steps to replicate it</li>
              <li>
                What kind of device (PC, Mac, Tablet, Phone, etc) you're using
              </li>
              <li>
                Which browser (Chrome, Safari, Edge, Firefox, etc) you're using
              </li>
              <li>What steps you've taken to troubleshoot the issue</li>
              <li>
                Photos or videos of the issue you're experiencing if you can
              </li>
            </ul>
            ...
            <h4 className="no-margin">Issues with Apple's Safari browser</h4>
            <p>
              If you have having trouble with the audible caller on an iOS/Apple
              device, ensure that you have Siri enabled on your device. The Web
              Speech Synthesis API requires Siri to be enabled to work. Also,
              the latest Safari is known to have some issues with the API,
              including not loading any voice options, so it is recommended to
              use Chrome.
            </p>
            ...
            <p>
              ...
              suggestions, comments, etc. I love hearing from players! Please
              remember that I'm just one developer, but I do my best to respond
              to everyone who emails me and help them however I can! Please
              reach out via email:{" "}
              <a href="mailto:hello@letsplaybingo.io">hello@letsplaybingo.io</a>{" "}
              or you can reach out using the{" "}
