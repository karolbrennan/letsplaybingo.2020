...
export default function Privacy() {
  useEffect(() => {
    document.title = "Let's Play Bingo! | Privacy Policy";
  });
  return (
    <section>
      <div className="container row">
        <div className="col">
          ...
          <p>
            Thank you for choosing to be part of our community at A Girl Created
            This LLC D/B/A ("doing business as") Let's Play Bingo (“Company”,
          ...
          <p>
            We do not actively collect information on our users. Please see the
            section below detailing information that is automatically collected
          ...
          <p>
            ...
            information with any third parties and any information shared within
            these correspondances will always remain confidential.
          </p>

          <h2>Information Automatically Collected</h2>
          <p>
            We automatically collect certain information when you visit, use or
            navigate the Site via Google Analytics as mentioned above. This
            ...
            primarily needed to maintain the security and operation of our Site,
            and for our internal analytics and reporting purposes.
          </p>
          <p>
            We, like many companies, utilize Google Analytics for analytics
            purposes. Please review the privacy policy set forth by Google here:{" "}
            <a
          ...
          <p>
            To be specific, Let's Play Bingo only uses localStorage technologies
            which are strings of text stored in your browser to save information
            about your gameplay preferences and game data. These "cookies" do
            not expire, but if you clear your cache and cookies in your browser
            they will disappear. We do not have a database, and we do not store
            information on any servers. When you visit our Site, we will send a
            request to your browser to check for these strings of text. If they
            exist we will retrieve them so we can resume your game or restore
            your game settings. This is not personal information about you, nor
            does it allow us to access personal information about you. It is
            strictly to improve your experience on the Site.
          </p>
          ...
          <p>
            ...
            review the policies of these third parties and contact them directly
          ...
          <p>
            ...
            any data we have collected from children under age 18, please
            contact us at{" "}
            <a href="mailto:hello@letsplaybingo.io">hello@letsplaybingo.io</a>.
          </p>
          ...
          <p>
            ...
            information on our users at this time. Should we ever introduce any
            of these features or the use of databases within our site we will
            update this privacy policy with information about your rights for
            removal of data stored in our servers.
          </p>
          <p>
          ...
          <p>
            ...
            registered account with the , you have the right to request removal
            of unwanted data that you publicly post on the . To request removal
            ...
            sure the data is not publicly displayed on the , but please be aware
          ...
          <p>
            We do not collect data from you. But if you'd like for us to delete
            any emails you've sent to us or anything of that nature, please
            email us at{" "}
            <a href="mailto:hello@letsplaybingo.io">hello@letsplaybingo.io</a>{" "}
